...
const SectionCard = ({
  ...
  const divhmFooterSeparatorStyle = useMemo(() => {
    return {
      top: arrowRightIconTop,
    };
  }, [arrowRightIconTop]);
  ...
  return (
    <div
      className="absolute top-[5696px] left-[0px] w-[1440px] h-[529px] text-left text-[17.16px] text-darkslategray-500 font-cta"
      style={frameDivStyle}
    >
      <div className="absolute top-[103px] left-[0px] w-[1440px] h-[370px]">
      ...
      />
      <div
        className="absolute top-[224px] left-[1159px] w-[239px] h-[299px] text-sm text-darkslategray-1200"
        style={frameDiv1Style}
      >
        <div
          className="absolute top-[287px] left-[0px] tracking-[0.28px] leading-[12px]"
          style={privacyPolicyStyle}
        >
          Privacy Policy
        </div>
        <div
          className="absolute top-[calc(50%_-_149.5px)] left-[100px] bg-darkslategray-1100 w-px h-[13px]"
          style={divhmFooterSeparatorStyle}
        />
        <div
          className="absolute top-[287px] left-[105px] tracking-[0.28px] leading-[12px]"
          style={termsConditionsStyle}
        >{`Terms & Conditions`}</div>
      </div>
      <div className="absolute top-[503px] left-[40px] text-sm tracking-[0.28px] leading-[25.6px] text-[inherit]">
        <a
      ...
      <div className="absolute top-[275px] left-[1257px] rounded-9xs bg-mediumaquamarine w-[134px] h-9" />
      <div className="absolute top-[280px] left-[1268px] w-[113px] h-[26px] text-center text-white">
        <div className="absolute top-[0px] left-[0px] leading-[25.6px] font-semibold">
          Subscribe
        </div>
        <img
          className="absolute top-[3px] left-[92px] w-[21px] h-[21px] overflow-hidden"
          alt=""
          src="/arrowright.svg"
        />
      </div>
